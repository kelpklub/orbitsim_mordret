...
"""
Enhanced Orbital Simulation with Dynamic Grid Scaling
====================================================

New Feature:
- Dynamic grid spacing that adjusts based on zoom level
- Coordinate markings always visible and readable
- Intelligent spacing intervals (1, 2, 5, 10, 20, 50, 100, etc.)
- Grid density automatically optimized for current zoom

All other features remain the same:
- SPACEBAR: Pause/Resume simulation  
- Enhanced velocity editing with text input
